...
// ---- HERO -----------------------------------------------------
// roleTapes: array of {label, color: 'pink'|'green'}
function Hero({ stencil, roleTapes, lede, primaryCta, secondaryCta }) {
  return (
...
// ---- SECTION HEAD --------------------------------------------
function SectHead({ tape, title, count, green }) {
  return (
