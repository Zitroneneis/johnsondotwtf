// Content data for all three pages — single source of truth so each
// page can render either inline (combined) or as a dedicated page.

window.PM_DATA = {
  stencil: '◆ SR. TECHNICAL PRODUCT MANAGER · 15+ YRS',
  roleTapes: [
    { label: 'Product', color: 'pink' },
    { label: 'Platform', color: 'green' },
  ],
  lede: "messy business problems → elegant engineering. 0-to-1 innovation, scaling global social platforms, building products people actually use.",
  about: [
    "I specialize in technical product management and platform strategy. My career has taken me from optimizing massive social video communities (Paltalk, Camfrog) to architecting next-gen AI learning platforms (TechSmart). I don't just write tickets — I prototype, test my own APIs, and speak fluent \"engineer.\"",
    "Whether it's transforming legacy systems or navigating complex regulatory landscapes, I focus on driving retention, revenue, and clarity.",
  ],
  skills: [
    'Funnel Optimization', 'Process Improvement', 'Monetization',
    'HTML/CSS', 'Agile/Scrum', 'GenAI', 'Prototyping',
    'Growth', 'Marketplaces', 'AI Engineer',
  ],
  // Lightweight career trail — kept loose so it can grow.
  trail: [
...
window.THEATRE_DATA = {
  stencil: '◆ HEAD AUDIO ENGINEER · ARTSWEST · SEA',
  roleTapes: [
  ...
  skills: [
    'Sound Design', 'A1', 'A2', 'Audio Grip/Deckhand', 'RF Tech',  'Electrics: Hanging', 'Electrics: Focus', 'Electrics: DMX', 'Board Op', 'Scenic Hand', 'Stagehand', 'Wrench',
  ],
  credits: [
    { yr: '2025', role: 'A1',                      show: 'Penelope',         house: 'ArtsWest' },
    { yr: '2025', role: 'A1',                      show: 'Man of La Mancha', house: 'Reboot/Theatre off Jackson' },
